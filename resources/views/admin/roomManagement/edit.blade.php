...
<div class="card">
    <div class="card-header">
        <h6 class="mb-0">Edit Room</h6>
    </div>

    <form class="wizard-form steps-basic" id="formSubmit" method="POST" action="{{ route('admin.room-management.update', $data->id) }}" enctype="multipart/form-data">
        @csrf
        @method('PUT')

        <h6>General</h6>
        <input type="hidden" name="property_id" value="{{ $data->property->id ?? null }}">
        <fieldset>
            <div class="row">
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <input type="text" name="room_name" value="{{ $data->room_name }}" id="room_name" class="form-control required" placeholder="Enter Room Name">
                    </div>
                </div>
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <select name="room_type_id" id="" class="form-select">
                            ...
                            @foreach ($room_type as $item)
                                <option value="{{ $item['id'] }}" {{ ($data->room_type_id == $item['id']) ? 'selected' : '' }}>{{ $item['name'] }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" name="number_of_room" value="{{ $data->number_of_room }}" id="number_of_room" class="form-control required"
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="umber" name="max_occupancy" value="{{ $data->max_occupancy }}" class="form-control required" placeholder="">
                ...
                <div class="col-lg-12 mt-3">
                    <div class="mb-3">
                        ...
                        @foreach ($data->bedroom as $item)
                            <div class="col-lg-12">
                                <div class="row">
                                    <div class="col-lg-2">
                                        <div class="mb-3">
                                            <label class="form-label">{{ $item->name }}</label>
                                            <input type="hidden" name="bedroom_name[]" value="{{ $item->name }}">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-3">
                                            <select name="bedroom_type_id[]" id="" class="form-select">
                                                ...
                                                @foreach ($bed_type as $detail)
                                                    <option value="{{ $detail['id'] }}" {{ ($detail['id'] == $item->bedroom_type_id) ? 'selected' : '' }}>{{ $detail['name'] }}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" name="room_width" value="{{ $data->room_width }}" class="form-control required" placeholder="">
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" name="room_length" value="{{ $data->room_length }}" class="form-control required" placeholder="">
                            <span class="input-group-text">Meters</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="number" name="min_rate" value="{{ $data->min_rate }}" class="form-control required" placeholder="">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">IDR</span>
                            <input type="number" name="extra_guest_fee" value="{{ $data->extra_guest_fee }}" class="form-control required" placeholder="">
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <input type="number" name="max_extra_bed" value="{{ $data->max_extra_bed }}" class="form-control required" placeholder="">
                ...
                <div class="col-lg-6">
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            <span class="input-group-text">IDR</span>
                            <input type="number" name="price_of_extra_bed" value="{{ $data->price_of_extra_bed }}" class="form-control required" placeholder="">
                        </div>
                    </div>
                </div>
            </div>
                                            ...
                                            <div class="col-lg-3 mb-2">
                                                <div class="border p-3 rounded">
                                                    <div class="d-flex align-items-center mb-2">
                                                        <input type="checkbox" id="dc_ls_u" name="facility_id[]" value="{{ $detail['facility_id'] }}" {{ in_array($detail['facility_id'], $data->facility()->pluck('facility_id')->toArray()) ? 'checked' : '' }}>
