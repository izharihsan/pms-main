                            ...
                            <div class="d-flex align-items-end flex-nowrap">
                                <button type="button" class="btn btn-outline-light ms-auto">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="category" value="Hotel" id="hotel" {{ $data->category == 'hotel' ? 'checked' : ''}}>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex align-items-end flex-nowrap">
                                <button type="button" class="btn btn-outline-light ms-auto form-check">
                                    <div class="form-check">
                                        <input class="form-check-input" type="radio" name="category" value="House" id="house" {{ $data->category == 'house' ? 'checked' : ''}}>
